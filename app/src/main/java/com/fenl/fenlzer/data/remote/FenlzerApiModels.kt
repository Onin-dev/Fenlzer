...
data class HealthData(
    ...
    val serverTime: String,
    val apiReachable: Boolean = true,
    val authenticated: Boolean,
    val databaseOk: Boolean = true,
    val workerRunning: Boolean = true,
    val activeJobsSupported: Boolean = true,
...
data class JobObject(
    ...
    val source: JobSource = JobSource(),
